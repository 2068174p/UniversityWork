...
public class GameWebPagesResource {
	...
	@Path("/result")
	/**
	 * The Web page that shows past game result
	 * Hosted at 'http://localhost:7777/toptrumps/result'
	 * @return
	 */
    public GameResultView getGameResult() {
	...
	@Path("/winner")
	/**
	 * The Web page that shows past game winner
	 * Hosted at 'http://localhost:7777/toptrumps/winner'
	 * @return
	 */
